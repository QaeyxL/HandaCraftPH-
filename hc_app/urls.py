...
urlpatterns = [
    ...
    path('product/<int:pk>/attributes/', views.product_attributes_api, name='product_attributes_api'),
    path('product/calculate-price/', views.calculate_custom_price, name='calculate_custom_price'),
    ...
    path('dashboard/workflow/create/', views.workflow_create, name='workflow_create'),
    path('dashboard/workflow/<int:task_id>/update/', views.workflow_update, name='workflow_update'),
    path('dashboard/workflow/<int:task_id>/delete/', views.workflow_delete, name='workflow_delete'),
    path('dashboard/stats/', views.dashboard_stats, name='dashboard_stats'),
    path('dashboard/cart-activity/', views.dashboard_cart_activity, name='dashboard_cart_activity'),
    path('dashboard/map-points/', views.dashboard_map_points, name='dashboard_map_points'),
    path('dashboard/quotes/<int:buyer_id>/', views.dashboard_quotes, name='dashboard_quotes'),
    path('admin/dashboard/', views.admin_dashboard, name='admin_dashboard'),
    path('admin/sales-api/', views.admin_sales_api, name='admin_sales_api'),
